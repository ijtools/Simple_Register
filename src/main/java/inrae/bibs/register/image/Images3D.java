...
public class Images3D
{
    ...
    /**
     * Optimize display range of 2d/3d image based on its minimum and maximum
     * values
     * 
     * @param image
     *            input image
            ...
            double vmax)
    {
        ...
        // Iterate on image voxels, and choose result value depending on dynamic
        // bounds
    ...
    public static final void replaceValue(ImagePlus image, double initialValue,
            double finalValue)
    {
    ...
    public static final byte[][] getByteArrays(ImageStack image)
    {
        ...
        {
            throw new IllegalArgumentException(
                    "Bit depth of input ImageStack must be 8");
        }
    ...
    public static final short[][] getShortArrays(ImageStack image)
    {
        ...
        {
            throw new IllegalArgumentException(
                    "Bit depth of input ImageStack must be 16");
        }
    ...
    public static final float[][] getFloatArrays(ImageStack image)
    {
        ...
        {
            throw new IllegalArgumentException(
                    "Bit depth of input ImageStack must be 32");
        }
