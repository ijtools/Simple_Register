 ...
 * @author dlegland
 */
public class LinearInterpolatedImage3D implements InterpolatedImage3D
{
	// ===================================================================
	// class variables
     ...
     *            the image containing values to interpolate.
     */
	public LinearInterpolatedImage3D(ImageStack image)
	{
		this.image = image;
	}
     ...
     */
	public LinearInterpolatedImage3D(ImageStack image, double padValue)
	{
		this.image = image;
