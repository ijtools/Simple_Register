 ...
 * @author dlegland
 */
public class NearestNeighborInterpolatedImage3D implements InterpolatedImage3D
{
	// ===================================================================
	// class variables
     ...
     *            the image containing values to interpolate.
     */
	public NearestNeighborInterpolatedImage3D(ImageStack image)
	{
		this.image = image;
	}
     ...
     */
	public NearestNeighborInterpolatedImage3D(ImageStack image, double padValue)
	{
		this.image = image;
