 ...
 * 
 * 
 * @see NearestNeighborInterpolatedImage2D
 * 
 * @author dlegland
 */
public class LinearInterpolatedImage2D implements InterpolatedImage2D
{
	// ===================================================================
	// class variables
     ...
     *            the image containing values to interpolate.
     */
	public LinearInterpolatedImage2D(ImageProcessor image)
	{
		this.image = image;
	}
     ...
     */
	public LinearInterpolatedImage2D(ImageProcessor image, double padValue)
	{
		this.image = image;
