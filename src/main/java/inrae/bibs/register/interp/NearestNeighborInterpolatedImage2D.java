 ...
 * @author dlegland
 */
public class NearestNeighborInterpolatedImage2D implements InterpolatedImage2D
{
	// ===================================================================
	// class variables
     ...
     *            the image containing values to interpolate.
     */
	public NearestNeighborInterpolatedImage2D(ImageProcessor image)
	{
		this.image = image;
	}
     ...
     */
	public NearestNeighborInterpolatedImage2D(ImageProcessor image, double padValue)
	{
		this.image = image;
